...
void pneumaticToggle() {
  if (pneumatic.value() == 1) {
    ...
    Controller1.Screen.print("Pneumatic Out");
  }
  else {
    pneumatic.set(1);
    Controller1.Screen.setCursor(5,1);
    Controller1.Screen.print("Pneumatic In");
  }
}
...
void pre_auton(void) {
  ...
  wait(2, sec);
  Controller1.ButtonLeft.pressed(speedToggle);
  ...
  Brain.Screen.drawRectangle(0, 0, 240, 90, "#0B4F6C");
  Brain.Screen.drawRectangle(240, 0, 240, 90, "#01BAEF");
  Brain.Screen.drawRectangle(0, 90, 240, 90, "#FBFBFF");
  Brain.Screen.drawRectangle(240, 90, 240, 90, "#040F16");
  Brain.Screen.drawRectangle(0, 180, 480, 60, "#B80C09");
