...
void pre_auton(void) {
  ...
  vexcodeInit();
  grabMotor.setTimeout(1, seconds);
...
void autonomous(void) {
  ...
  if (autonType == 3) {
    driveInches(-24, 100);
    grab();
    rightMotors.spinFor(directionType::fwd, 0.5, rotationUnits::deg, false);
    leftMotors.spinFor(directionType::fwd, 5, rotationUnits::rev);
    liftMotors.spinFor(60 * 5, rotationUnits::rev);
    driveInches(54, 100);
  }
}
